...
{
    public partial class RoizingAssortments
    {
        public RoizingAssortments()
        {
            RoizingAssortmentPeriods = new HashSet<RoizingAssortmentPeriods>();
            RoizingAssortmentRows = new HashSet<RoizingAssortmentRows>();
        }
        ...
        public virtual ICollection<RoizingAssortmentPeriods> RoizingAssortmentPeriods { get; set; }
        public virtual ICollection<RoizingAssortmentRows> RoizingAssortmentRows { get; set; }
    }
}